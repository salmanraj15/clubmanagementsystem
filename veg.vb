Public Class veg
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Const strInsert As String = "INSERT INTO veg([Product ID], [Name], [Quantity], [Cost Price], [Selling Price]) values (@CN,@CD,@PN,@D1,@t1)"
        Dim con1 As New SqlClient.SqlConnection(ConnectionString)
        Dim cmdInsert As New SqlClient.SqlCommand(strInsert, con1)

        con1.Open()
        For Each DGR As DataGridViewRow In VegDataGridView.Rows
    ...
    Private Sub VegBindingNavigatorSaveItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles VegBindingNavigatorSaveItem.Click
        Me.Validate()
        Me.VegBindingSource.EndEdit()
